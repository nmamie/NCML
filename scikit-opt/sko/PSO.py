        ...
        for iter_num in range(self.max_iter):
            ...
            if precision is not None:
                ...
                if tor_iter < precision:
                    ...
                    c = 0
            if self.verbose:
                print('Iter: {}, Best fit: {} at {}'.format(iter_num+1, self.gbest_y, self.gbest_x))
            # progress_bar update
            progress_bar.update(1)
            progress_bar.set_description(f"Iter: {iter_num+1} | Best fit: {self.gbest_y} at {self.gbest_x}")
